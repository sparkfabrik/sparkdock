...
├─────────────────────────────────────────────────────────┤
│                                                          │
│ Sparkdock now includes a modern shell configuration     │
│ system with smart aliases, conditional tool loading     │
│ (eza, bat, fzf, starship), and seamless oh-my-zsh      │
│ integration. New sjust commands let you enable/disable  │
│ features and view comprehensive shell status.           │
│                                                          │
├─────────────────────────────────────────────────────────┤
...
├─────────────────────────────────────────────────────────┤
│                                                          │
│ The HTTP proxy now automatically generates SSL          │
│ certificates for local development and configures DNS   │
│ resolution for .loc domains. Access monitoring          │
│ dashboards through the new Traefik integration.         │
│                                                          │
├─────────────────────────────────────────────────────────┤
│ Commit: b4c5d6e by sparkfabrik                          │
└─────────────────────────────────────────────────────────┘
```
...
```json
{
  "text": "🎉 New Sparkdock features merged to master!",
  "blocks": [
    {
      "type": "header",
      "text": {
...
- ✅ New significant user-facing features are added
