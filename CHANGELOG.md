...
- Added a dedicated Claude Code Usage section to Sparkdock Manager with separate five-hour and weekly utilization rows, reset times, stale and authentication states, manual refresh, and automatic `claude-usage` provider installation without its separate desktop reader
