...
- Added `sjust sf-copilot-premium-usage` recipe with formatted dashboard showing premium request usage, quota bars, plan info, and reset countdown (supports `--json` for raw API output)
