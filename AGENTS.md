...
- `claude-sa-gate-{enable,disable,info}` — manage the Claude Code coding-agent SA gate (activate with `SF_AGENT_SA_GUARD=warn|enforce`; bypass at runtime with `SPARKDOCK_SA_GATE=0`)
